...
pub fn create(state: &ServerState, id: u64, address: JsonApiRecord<Address>) -> JsonResult {
...
pub fn destroy(state: &ServerState, id: u64, address: JsonApiRecord<Address>) -> JsonResult {
